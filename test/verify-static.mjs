...
const nicknameThreadHtml = await readFile('threads/funny-nickname/index.html', 'utf8');
const ajaeThreadHtml = await readFile('threads/ajae-joke-contest/index.html', 'utf8');
const badQuoteThreadHtml = await readFile('threads/bad-writing-quote-contest/index.html', 'utf8');
...
assertIncludes(homeHtml, '3 rooms / 10 saves', 'index.html');
assertIncludes(homeHtml, '10 saved posts', 'index.html');
...
assertNotIncludes(mindHtml, 'https://www.threads.com/@sienna__ai/post/DX4edcwCY0X', 'play/mind/index.html');
...
assertIncludes(funnyHtml, '웃긴 닉네임', 'play/funny/index.html');
assertIncludes(funnyHtml, '../../threads/funny-nickname/', 'play/funny/index.html');
assertIncludes(funnyHtml, '아재개그 대회', 'play/funny/index.html');
assertIncludes(funnyHtml, '../../threads/ajae-joke-contest/', 'play/funny/index.html');
assertIncludes(funnyHtml, '천하제일 똥글 명언 대회', 'play/funny/index.html');
assertIncludes(funnyHtml, '../../threads/bad-writing-quote-contest/', 'play/funny/index.html');
assertNotIncludes(funnyHtml, '웃긴 닉네이', 'play/funny/index.html');
assertNotIncludes(funnyHtml, 'https://www.threads.com/@soon_bu.li/post/DZOO7rPkyVM', 'play/funny/index.html');
assertNotIncludes(funnyHtml, 'https://www.threads.com/@dowalighting/post/DZmTZAskyWY', 'play/funny/index.html');
assertNotIncludes(funnyHtml, 'https://www.threads.com/@depth_corp/post/DZt3w_UH0Oc', 'play/funny/index.html');
...
assertIncludes(nicknameThreadHtml, '<title>웃긴 닉네임 - yesir.softdaddy-o.com</title>', 'threads/funny-nickname/index.html');
assertIncludes(nicknameThreadHtml, '지금까지 봤던 닉네임 중에', 'threads/funny-nickname/index.html');
assertIncludes(nicknameThreadHtml, '로그인 세션으로 스크롤 캡처한 Threads 댓글 98개', 'threads/funny-nickname/index.html');
assertIncludes(nicknameThreadHtml, '캡처</dt><dd>30장</dd>', 'threads/funny-nickname/index.html');
assertIncludes(nicknameThreadHtml, 'id="reply-98"', 'threads/funny-nickname/index.html');
assertIncludes(nicknameThreadHtml, 'data-thread-sort-toggle', 'threads/funny-nickname/index.html');
assertIncludes(nicknameThreadHtml, 'https://www.threads.com/@soon_bu.li/post/DZOO7rPkyVM', 'threads/funny-nickname/index.html');

assertIncludes(ajaeThreadHtml, '<title>아재개그 대회 - yesir.softdaddy-o.com</title>', 'threads/ajae-joke-contest/index.html');
assertIncludes(ajaeThreadHtml, '아재개그 대회 열겠습니다', 'threads/ajae-joke-contest/index.html');
assertIncludes(ajaeThreadHtml, '로그인 세션으로 스크롤 캡처한 Threads 댓글 317개', 'threads/ajae-joke-contest/index.html');
assertIncludes(ajaeThreadHtml, '캡처</dt><dd>100장</dd>', 'threads/ajae-joke-contest/index.html');
assertIncludes(ajaeThreadHtml, 'id="reply-317"', 'threads/ajae-joke-contest/index.html');
assertIncludes(ajaeThreadHtml, 'data-thread-sort-toggle', 'threads/ajae-joke-contest/index.html');
assertIncludes(ajaeThreadHtml, 'https://www.threads.com/@dowalighting/post/DZmTZAskyWY', 'threads/ajae-joke-contest/index.html');

assertIncludes(badQuoteThreadHtml, '<title>천하제일 똥글 명언 대회 - yesir.softdaddy-o.com</title>', 'threads/bad-writing-quote-contest/index.html');
assertIncludes(badQuoteThreadHtml, '지금부터 천하제일 똥글 명언 대회를 시작한다', 'threads/bad-writing-quote-contest/index.html');
assertIncludes(badQuoteThreadHtml, '로그인 세션으로 스크롤 캡처한 Threads 댓글 93개', 'threads/bad-writing-quote-contest/index.html');
assertIncludes(badQuoteThreadHtml, '캡처</dt><dd>48장</dd>', 'threads/bad-writing-quote-contest/index.html');
assertIncludes(badQuoteThreadHtml, 'id="reply-93"', 'threads/bad-writing-quote-contest/index.html');
assertIncludes(badQuoteThreadHtml, 'data-thread-sort-toggle', 'threads/bad-writing-quote-contest/index.html');
assertIncludes(badQuoteThreadHtml, 'https://www.threads.com/@depth_corp/post/DZt3w_UH0Oc', 'threads/bad-writing-quote-contest/index.html');
...
assertExists('data/threads/funny-nickname.json');
assertExists('data/threads/ajae-joke-contest.json');
assertExists('data/threads/bad-writing-quote-contest.json');
...
if (/[\uFFFD\u5a9b\u6e72\uf9ce\uc9cc]/.test(homeHtml + mindHtml + selfGrowthHtml + funnyHtml + threadHtml + nicknameThreadHtml + ajaeThreadHtml + badQuoteThreadHtml)) {
